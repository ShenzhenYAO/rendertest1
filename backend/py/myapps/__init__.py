...
def doSomethingAtBackend():
    ...
    if requesttask == 'get_processed_textjson':
        responsedatafrombackend_json= get_processed_textjson(requestdatafromfrontend_json)
    elif requesttask == 'xxxxxx':
        pass
        # responsedatafrombackend_json= get_spacytest_data(requestdatafromfrontend_json)
